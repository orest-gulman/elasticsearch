...
try:
    #r = requests.get('https://dxkibana.euroware.it:9200/_cat/indices?pri&h=index', auth = HTTPBasicAuth('admin', 'RFhnbyRF'), verify=False)
    ...
    if r_get.status_code == 200:
        try:
            ...
            send_mail('dxkibana function failed', str(e))
            sys.exit()
    else:
